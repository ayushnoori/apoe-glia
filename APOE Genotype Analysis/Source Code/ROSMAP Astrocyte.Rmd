...
TableS6 = tT_CERAD[, .(EnsemblID, GeneSymbol, E4vsE3_logFC, E4vsE3_P.Value, E2vsE3_logFC, E2vsE3_P.Value)]
...
intersect(tT3_Braak[E4vsE3_P.Value < 0.05,]$GeneSymbol,tT3_CERAD[E4vsE3_P.Value < 0.05,]$GeneSymbol) # 5 in common
...
nrow(tT4_CERAD[E4vsE3_P.Value < 0.05,]) ## 107
...
# Table S6
Cluster = clustLab
TableS6 = as.data.frame(cbind(Cluster, zMtx))
setDT(TableS6)
TableS6[, GeneSymbol := z$Genes]
TableS6 = annot2[GeneSymbol %in% TableS6$GeneSymbol][TableS6, on = .(GeneSymbol)]
TableS6 = TableS6[clustLab %in% c(1,4),]
TableS6 = TableS6[order(Cluster, GeneSymbol),]
fwrite(TableS6, "TableS6.csv")
```
...
pdf("../TablesFigures/Figure5-1.cluster1.pdf", width = 11)
...
pdf("../TablesFigures/Figure5-1.cluster4.pdf", width = 11)
Heatmap(zMtx[order(clustLab),], 
        col = colFun1,
        cluster_columns = FALSE,
        cluster_rows = FALSE,
...
my_violin = function(c, TableS2.astro){
        ...
        # violin plot
        fig4b.1 = ggplot(my.df, aes(x=APOE.num, y=`z-score`, group=APOE, fill = APOE)) + 
        ...
        # box plot
        fig4b.2 = ggplot(data = my.df, aes(x=APOE, y=`z-score`, group=APOE, fill = APOE)) +
        geom_boxplot(outlier.colour="black", outlier.shape=16,
               outlier.size=2, notch=FALSE) +
        scale_fill_manual(values = rev(to_swap)) +
        ylab("Ave z-score")

        return(list(fig4b.1, fig4b.2))
}

fig4b.c1 = my_violin(1, TableS2.astro)
fig4b.c4 = my_violin(4, TableS2.astro)

fig4b.c1.p = ggarrange(plotlist = fig4b.c1, ncol = 2)
fig4b.c4.p = ggarrange(plotlist = fig4b.c4, ncol = 2)
fig4b.c1.p = annotate_figure(fig4b.c1.p, fig.lab = "C",
                             fig.lab.size = 20)
fig4b.c4.p = annotate_figure(fig4b.c4.p, fig.lab = "D", 
                             fig.lab.size = 20)

ggsave("../TablesFigures/Figure4B-c1.pdf", fig4b.c1.p, width = 5.5, height = 4)
ggsave("../TablesFigures/Figure4B-c4.pdf", fig4b.c4.p, width = 5.5, height = 4)
```
...
```{r}
# Cluster 4 genes:
tbS2 = fread("TableS2-astro.csv")
C4.genes = tbS2[clustLab == 4, GeneSymbol]
C1.genes = tbS2[clustLab == 1, GeneSymbol]
...
# Remove subjects has no APOE or CERAD record
sel = (!is.na(E)) & (!is.na(C))
mDataG1 = mDataG1[, sel]
