...
This script analyzes data from the frontal pole (FP).
...
# run Model 1
tT_CERAD = run_model1("CERAD", mDataG, C, E, annot, "MSBBFP", "microglia")  # CERAD (sample n = 261)
tT_Braak = run_model1("Braak", mDataG, B, E, annot, "MSBBFP", "microglia")  # Braak (sample b = 249)

nrow(tT_CERAD[E4vsE3_P.Value < 0.05]) ## 5 E4-E3
nrow(tT_Braak[E4vsE3_P.Value < 0.05]) ## 5 E4-E3

intersect(tT_Braak[E4vsE3_P.Value < 0.05]$GeneSymbol,tT_CERAD[E4vsE3_P.Value < 0.05]$GeneSymbol) # 4 in common

length(tT_CERAD[E4vsE3_P.Value < 0.05 & E4vsE3_logFC > 0,]$GeneSymbol) # 5 up in E4-E3
length(tT_CERAD[E4vsE3_P.Value < 0.05 & E4vsE3_logFC < 0,]$GeneSymbol) # 0 down in E4-E3
length(tT_Braak[E4vsE3_P.Value < 0.05 & E4vsE3_logFC > 0,]$GeneSymbol) # 5 up in E4-E3
length(tT_Braak[E4vsE3_P.Value < 0.05 & E4vsE3_logFC < 0,]$GeneSymbol) # 0 down in E4-E3

# Table S4
TableS4 = fread("TableS4.csv")
TableS4[tT_CERAD, on="EnsemblID",  c("MSBB-FP_E4vsE3_logFC", "MSBB-FP_E4vsE3_P.Value", "MSBB-FP_E2vsE3_logFC", "MSBB-FP_E2vsE3_P.Value") := .(i.E4vsE3_logFC, i.E4vsE3_P.Value, i.E2vsE3_logFC, i.E2vsE3_P.Value)]
...
nrow(tT1.sfE[tT1.sfE$P.Value < 0.05, ])  # E4Num: 10
nrow(tT2.sfE[tT2.sfE$P.Value < 0.05, ])  # E2Num: 16

E4Coeff = tT_CERAD_ENum$coefficients[,2]
E2Coeff = tT_CERAD_ENum$coefficients[,3]
all(names(E4Coeff) == tT1.sfE$EnsemblID)

# 4 in common (with E4 coeff > 0)
...
E4.Genes.1 = tT1.sfE[tT1.sfE$P.Value < 0.05 & E4Coeff > 0, "GeneSymbol"] # 9
length(E4.Genes.1)
E2.Genes.2 = tT2.sfE[tT2.sfE$P.Value < 0.05 & E2Coeff < 0, "GeneSymbol"] # 6
length(E2.Genes.2)
intersect(E4.Genes.1, E2.Genes.2) # 0

tT1.sfE$coefficients = E4Coeff
tT2.sfE$coefficients = E2Coeff
fwrite(tT1.sfE, "../Data/limmaResult/MSBB-FP-model1.5-E4Num.csv")
fwrite(tT2.sfE, "../Data/limmaResult/MSBB-FP-model1.5-E2Num.csv")

# Table S5
setDT(tT1.sfE)
setDT(tT2.sfE)
TableS5 = fread("TableS5.csv")
TableS5 = TableS5[tT1.sfE, on = .(EnsemblID, GeneSymbol), c("MSBB-FP_e4_dosage_logFC", "MSBB-FP_e4_dosage_P.Value", "MSBB-FP_e4_dosage_coefficients") := .(i.logFC, i.P.Value, i.coefficients)]
TableS5 = TableS5[tT2.sfE, on = .(EnsemblID, GeneSymbol), c("MSBB-FP_e2_dosage_logFC", "MSBB-FP_e2_dosage_P.Value", "MSBB-FP_e2_dosage_coefficients") := .(i.logFC, i.P.Value, i.coefficients)]
fwrite(TableS5, "TableS5.csv")


# run Model 2
tT2_CERAD = run_model2("CERAD", mDataG, C, E, annot, "MSBBFP", "microglia") 
tT2_Braak = run_model2("Braak", mDataG, B, E, annot, "MSBBFP", "microglia")

nrow(tT2_CERAD[E4vsE3_P.Value < 0.05]) # 52 E4-E3
nrow(tT2_Braak[E4vsE3_P.Value < 0.05]) # 142 E4-E3

length(intersect(tT2_Braak[E4vsE3_P.Value < 0.05]$GeneSymbol,tT2_CERAD[E4vsE3_P.Value < 0.05]$GeneSymbol)) # 21 in common

length(tT2_CERAD[E4vsE3_P.Value < 0.05 & E4vsE3_logFC > 0,]$GeneSymbol) # 51 up in E4-E3
length(tT2_CERAD[E4vsE3_P.Value < 0.05 & E4vsE3_logFC < 0,]$GeneSymbol) # 1 down in E4-E3
length(tT2_Braak[E4vsE3_P.Value < 0.05 & E4vsE3_logFC > 0,]$GeneSymbol) # 140 up in E4-E3
length(tT2_Braak[E4vsE3_P.Value < 0.05 & E4vsE3_logFC < 0,]$GeneSymbol) # 2 down in E4-E3


# add to Table S2
TableS2 = fread("TableS2.csv")
TableS2[tT2_CERAD, on="EnsemblID",  c("MSBB.FP_E4vsE3_logFC", "MSBB.FP_E4vsE3_P.Value", "MSBB.FP_E2vsE3_logFC", "MSBB.FP_E2vsE3_P.Value") := .(i.E4vsE3_logFC, i.E4vsE3_P.Value, i.E2vsE3_logFC, i.E2vsE3_P.Value)]
fwrite(TableS2, "TableS2.csv")


# add to Table S3
TableS3 = fread("TableS3.csv")
TableS3[tT_CERAD, on="EnsemblID",  c("MSBB.FP_E4vsE3_logFC", "MSBB.FP_E4vsE3_P.Value", "MSBB.FP_E2vsE3_logFC", "MSBB.FP_E2vsE3_P.Value") := .(i.E4vsE3_logFC, i.E4vsE3_P.Value, i.E2vsE3_logFC, i.E2vsE3_P.Value)]
...
# violin plot
figs1.fp.1 = ggplot(my.df, aes(x=APOE.num, y=`z-score`, group=APOE, fill = APOE)) + 
...
# box plot
figs1.fp.2 = ggplot(data = my.df, aes(x=APOE, y=`z-score`, group=APOE, fill = APOE)) +
  geom_boxplot(outlier.colour="black", outlier.shape=16,
               outlier.size=2, notch=FALSE) +
  scale_fill_manual(values = rev(to_swap)) +
  ylab("Ave z-score")
  
figs1.fp = figs1.fp.1 + figs1.fp.2 +
  plot_annotation(title = 'B', theme = theme(plot.title = element_text(face = "plain", size = 20)))
ggsave("../TablesFigures/FigureS1-violin-FP.pdf", figs1.fp, width = 5, height = 4, dpi = 300)
```
...
pic = wrap_plots(grobs = plist, guides = 'collect', design = layoutplot) +
  plot_annotation(title = 'C', theme = theme(plot.title = element_text(face = "plain", size = 15)))
ggsave("../TablesFigures/FigureS1-box-FP.pdf", pic, width = 12, height =8)
```
