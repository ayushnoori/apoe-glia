...
# run Model 1
tT_CERAD = run_model1("CERAD", mDataG, C, E, annot, "MSBBFP", "microglia")
tT_Braak = run_model1("Braak", mDataG, B, E, annot, "MSBBFP", "microglia")
...
TableS4[tT_CERAD, on="EnsemblID",  
        c("MSBB-FP_E4vsE3_logFC", "MSBB-FP_E4vsE3_CI.L", "MSBB-FP_E4vsE3_CI.R", 
          "MSBB-FP_E4vsE3_P.Value", "MSBB-FP_E4vsE3_adj.P.Val", 
          "MSBB-FP_E2vsE3_logFC", "MSBB-FP_E2vsE3_CI.L", "MSBB-FP_E2vsE3_CI.R", 
          "MSBB-FP_E2vsE3_P.Value", "MSBB-FP_E2vsE3_adj.P.Val") := .(
...
TableS5 = TableS5[tT1.sfE, on = .(EnsemblID, GeneSymbol), 
                  c("MSBB-FP_e4_logFC", "MSBB-FP_e4_CI.L", "MSBB-FP_e4_CI.R",
                    "MSBB-FP_e4_P.Value", "MSBB-FP_e4_adj.P.Val") := .(
                    i.logFC, i.CI.L, i.CI.R, i.P.Value, i.adj.P.Val)]
TableS5 = TableS5[tT2.sfE, on = .(EnsemblID, GeneSymbol), 
                  c("MSBB-FP_e2_logFC", "MSBB-FP_e2_CI.L", "MSBB-FP_e2_CI.R",
                    "MSBB-FP_e2_P.Value", "MSBB-FP_e2_adj.P.Val") := .(
                    i.logFC, i.CI.L, i.CI.R, i.P.Value, i.adj.P.Val)]
